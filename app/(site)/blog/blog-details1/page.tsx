...
const SingleBlogPage = () => {
  ...
  const heroImages = [
    "/images/blog/feature3.jpg",
    "/images/blog/road-1.png",
    "/images/blog/road2.png",
    "/images/blog/road3.png",
  ];
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="mb-8 text-xl leading-relaxed text-gray-700 dark:text-gray-300">
                {t("blog-details1.introduction")}
              </p>

              <p className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                {t("blog-details1.details")}
              </p>

              <p className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                {t("blog-details1.section1")}
              </p>

              <p className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                {t("blog-details1.section2")}
              </p>

              <p className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                {t("blog-details1.section3")}
              </p>

              <p className="mb-8 text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                {t("blog-details1.section4")}
              </p>
            </div>
          </div>
        </div>
